...
\begin{itemize}
\item \underline{{\bf left edge}} (right, top and bottom edge gradient coupling matrices are obtained in a similar manner)  %(assumed $\bs{n}\cdot\bs{1}_x = 1$)
\begin{equation}
\begin{split}
...
\begin{itemize}
\item \underline{{\bf vertical edge}} (right, top and bottom edge gradient coupling matrices are obtained in a similar manner)  %(assumed $\bs{n}\cdot \bs{1}_x =1$) :
\begin{equation}
\begin{split}
